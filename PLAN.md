...
| Context compression | `headroom-context-compression` | Tool profile | Large repos, verbose logs, long sessions, RAG-heavy workflows, or multi-agent memory need explicit opt-in context compression/proxy/MCP guidance. |

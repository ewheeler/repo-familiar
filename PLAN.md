...
| OpenCode project config | `opencode.json`, `opencode-playwright-mcp`, `opencode-cq-mcp`, `opencode-context7-mcp`, `opencode-headroom-mcp` | Harness-specific config plus opt-in tool profiles | Repos use OpenCode and need vendored skill discovery or non-secret project-level MCP entries. |
